...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderModel createOrder(Integer userId, Integer itemId, Integer promoId,Integer amount) throws BusinessExeption {
        ...
        if(promoId!=null){
            if(promoId.intValue()!=(itemModel.getPromoModel().getId())){
                throw  new BusinessExeption(EmBusinessError.PARAMETER_VALIDATION_ERROR,"活动信息正确");
